...
@RestController
@RequestMapping("/api/jhipster-application-1-kafka")
public class JhipsterApplication1KafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterApplication1KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterApplication1KafkaResource(KafkaProperties kafkaProperties) {
