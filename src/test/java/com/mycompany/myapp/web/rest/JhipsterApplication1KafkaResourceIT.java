...
class JhipsterApplication1KafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterApplication1KafkaResource kafkaResource = new JhipsterApplication1KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-application-1-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-application-1-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
